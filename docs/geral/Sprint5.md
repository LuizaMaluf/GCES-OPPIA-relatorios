...
**Período da Sprint:** [06/11 – 20/11]

## 1\. Objetivos da Sprint

  * Realizar o trabalho individual solicitado pela professora.
  * Manter acompanhamento das discussões e issues abertas previamente.
  * Transformar as discussões sobre problemas de instalação em contribuições oficiais (Issues e PRs) e resolver pendências de configuração do ambiente.

## 2\. Entregas Coletivas

| Entrega | Status | Link/Referência | Observações |
| :--- | :--- | :--- | :--- |
| Execução do trabalho individual indicado pela professora | Concluído | — | Foco direcionado ao trabalho individual. |
| Abertura de Pull Request| Concluído | [PR \#23825](https://github.com/oppia/oppia/pull/23825) | PR de documentação aberto. |
| Acompanhamento das Discussões e Issues | Em andamento | Discussions e Issues do Oppia | Aguardando retorno dos maintainers em pontos específicos. |
...
## 6\. Lições Aprendidas
  ...
  * A importância de adaptação no planejamento quando a comunidade do projeto não responde dentro do período esperado.
  * Aprendizado sobre como justificar a criação de uma Issue a partir de uma Discussion (comunicação com a comunidade).
  * Valor do trabalho individual como forma de continuar evoluindo mesmo sem progresso imediato no repositório principal.

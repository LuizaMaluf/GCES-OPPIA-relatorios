...
| Pedro Sampaio          | Criação do fork; Estudo da documentação e políticas de contribuição; Configuração do ambiente Linux; Organização no repositório de doc. | [diario de bordo](../contribuicoes_individuais/PedroSampaio-211043745/Sprint0.md)     | Concluído   |
